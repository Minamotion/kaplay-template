...
async function loadGame() {
	...
	//#endregion
	//#region [Load assets from kSettings]
	console.info("Started loading assets from asset list: ", kSettings.assets)
	let oopsies = 0
	for (let index = 0; index < kSettings.assets.length; index++) {
		const data = kSettings.assets[index]
